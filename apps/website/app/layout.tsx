...
export default function RootLayout({ children }: { children: ReactNode }) {
	return (
		<>
			<html lang="en-us">
			<body
				className={`${inter.className} ${default_card_font.variable} ${default_cardpage_font.variable} relative grid min-h-screen grid-rows-1 flex-col justify-items-center px-4 py-2.5 sm:py-4`} // bg-indigo-200
				style={{
					background:
